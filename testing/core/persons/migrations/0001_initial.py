...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('persons_profile', (
            ...
            ('birthday', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 9, 0, 0))),
    ...
    models = {
        ...
        'persons.profile': {
            ...
            'birthday': ('django.db.models.fields.DateField', [], {'default=datetime.datetime(2012, 8, 9, 0, 0)'}),
