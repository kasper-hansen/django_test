...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.day_of_birth'
        #db.delete_column('persons_profile', 'day_of_birth')

        # Adding field 'Profile.hello_world_day'
        db.add_column('persons_profile', 'hello_world_day',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 9, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.day_of_birth'
        db.add_column('persons_profile', 'day_of_birth',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 9, 0, 0)),
                      keep_default=False)

        # Deleting field 'Profile.hello_world_day'
        db.delete_column('persons_profile', 'hello_world_day')
    ...
    models = {
        ...
        'persons.profile': {
            ...
            'hello_world_day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 9, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
